...
const message = {
    commons: {
        ...
        msg: {
            ...
            fileNameErr:
                'Bạn chỉ có thể tải lên các tệp có tên chứa từ 1 đến 256 ký tự, bao gồm tiếng Anh, tiếng Trung, số hoặc dấu chấm',
        ...
        res: {
            ...
            forbidden: 'Người dùng hiện tại không có quyền truy cập',
